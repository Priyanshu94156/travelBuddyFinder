...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $.get(url, (data) => {
        ...
        for (var i = 0; i < data.length; i++) {
            console.log(data[i].LastEle)
            if (data[i].LastEle == 2) {
                count_silver++;
            }
            else if (data[i].LastEle == 5) {

                count_gold++;
            }
            else if (data[i].LastEle == 10) {
                count_platinum++;
            }
        }
        console.log(count_gold)
        console.log(count_platinum)
        console.log(count_silver)
...
function getUsersData() {
    ...
    $(document).ready(function () {
        $.get(urls+'/user/fetchAllUsers', (data) => {
...
function getTripsData() {
    ...
    $(document).ready(function () {
        $.get(urls+'/trip/fetchAllTrips', (data) => {
            console.log("trips");
            console.log(data);
